...
- Firestore 규칙은 `firestore.rules`에 보관한다. 읽기는 공개하고, 쓰기는 Google 로그인 사용자가 자신의 최고 기록만 저장·갱신할 수 있도록 제한한다.
- Firebase Authentication에서 Google 로그인을 활성화하고, 승인된 도메인에 `ensacom2019.github.io`를 추가해야 한다.
